...
class TransitOrders extends StatelessWidget {
  TransitOrders({super.key});
              ...
              children: [
                Column(
                  ...
                  children: [
                    ...
                    //     text: "Items: 10",
                    //     style:
                    //         TextStyle(color: greyScale, fontSize: 14),
                    //     children: [
                    //       TextSpan(
                    ...
                    Text(
                      'Picked:${ChatTimeFormatter.getFormattedDateTime(context, order.received)}',
                      style: TextStyle(color: greyScale, fontSize: 14),
                    ),
                    const SizedBox(
                      height: 4,
                ...
                InkWell(
                  onTap: () {
                    showModalBottomSheet(
                      ...
                      builder: (ctx) {
                        return bottomSheet(order, context);
                      },
                    );
                  },
                  child: const Icon(
  ...
  Widget bottomSheet(Orders order, BuildContext context) {
