...
class SingleClickyPlayer extends StatefulWidget {
  final Clicky clicky;
  const SingleClickyPlayer({super.key, required this.clicky});

  @override
  State<SingleClickyPlayer> createState() => _SingleClickyPlayerState();
}

class _SingleClickyPlayerState extends State<SingleClickyPlayer> {
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          margin:
                              EdgeInsets.only(top: size.height / 5, right: 8),
                          child: Column(
                            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                            children: [
                              IconButton(
